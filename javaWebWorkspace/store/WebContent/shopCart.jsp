...
<body>
	...
	<c:if test="${empty sessionScope.cartmap }">
		...
		<!--中间部分-->
		<div class="empty">
			<a href="index.jsp"><img src="images/empty_03.png" class="car">
			</a>
		</div>
	</c:if>
			...
			<div class="mainCenter">
				...
				<div class="mainPro">
					...
					<c:forEach items="${sessionScope.cartmap }" var="entry">
						<div class="bb">
							<input type="checkbox" name="prod"> <img
							...
							<div class="righ">
								<div class="rig" style="margin-top: 5px;">
									<a href="product/delCartProd?id=${entry.key .id }">删除</a>
								</div>
							</div>
						</div>						
					</c:forEach>
				...
				<script type="text/javascript">
		  			function changeNum(id,obj,oldnum){
		  				...
		  				window.location.href="product/changCartProd?id="+id+"&buyNum="+obj.value;
		  			}	  			
		  	</script>	
		  	
		  	<script type="text/javascript">
		  		$("input[name='prod']").select(function(){
		  			var checkedNum=$("input[name='prod']:checked").size();
					alert(checkedNum); 			
		  		});
