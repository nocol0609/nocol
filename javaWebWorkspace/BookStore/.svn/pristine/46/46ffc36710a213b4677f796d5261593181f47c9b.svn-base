            ...
            <div class="cn5_top_y center01">
            	<div class="cn5topy_1">
                	<div class="cn5topy_imgview">
                    	<img src="/BookStore/${product.images }"/>
                        <ul class="cn5topy_imglist">
                        	<li><a href="#"><img src="/BookStore/${product.images }"></a></li>
                            <li class="current"><a href="#"><img src="/BookStore/${product.images }"></a></li>
                            <li><a href="#"><img src="/BookStore/${product.images }"></a></li>
                            <li><a href="#"><img src="/BookStore/${product.images }"></a></li>
                            <li><a href="#"><img src="/BookStore/${product.images }"></a></li>
                        </ul>
                ...
                <div class="cn5topy_2">
                    ...
                    <div class="pro_buy">
                        ...
                        <c:if test="${sessionScope.user != null}">
                        <div class="pro_addshop"> <a id="addCart"  href="addCart?id=${product.id}&number=1">加入购物车 </a></div>
                        </c:if>
                        <c:if test="${sessionScope.user == null}">
                    ...
                    <script type="text/javascript">
                   		$("#add").click(function(){
							...
							var hrefOne = "addCart?id="+${product.id}+"&number="+number+"";                  			
                   		...
                   		$("#sub").click(function(){
    						...
    						var hrefTwo = "addCart?id="+${product.id}+"&number="+number+"";                  			
                   		...
                   		function checkNumber(num) {          
							...
							var href = $("#addCart").attr("href");  
							var hrefThree = "addCart?id="+${product.id}+"&number="+number+"";
                ...
                <!--内容-->
              	<div class="c5_b2_right_1 box">
                    ...
                    <div class="intro_pics">
                    	<img class="intro_pic" src="/BookStore/${product.images }"
