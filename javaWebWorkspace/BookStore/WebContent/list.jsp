    ...
    <div class="container4">
    	...
    	<div class="c4_b1">
        	<ul class="c4_b1_boxes">
            	...
            	<li>
                	<a href="prodInfor?id=${hotProduct.id }"><img src="${hotProduct.images }"></a>
                    <div class="c4_b1_box_txt">
                    	<p>${hotProduct.name } </p>
                        <h1>活动价：<b>${hotProduct.price }</b></h1>
                        <h2><a href="prodInfor?id=${hotProduct.id }">立即抢购</a></h2>
                    </div>
                </li>
               </c:forEach>
            </ul>
            	...
            	<ul class="c4_b5_c_boxes">
            		<c:if test="${requestScope.categoryDetailName ==null }">            
                    	...
                    	<div class="c4_b5_c_box_pic">
                        	<div class="c4b5_pic_view">
                            	<a href="prodInfor?id=${cateProdList.id }"><img src="${cateProdList.images }"></a>
                            </div>
                        </div>
                        <!--价钱-->
                        <div class="c4_b5_c_box_txt">
                        	<h1>￥ ${cateProdList.price }</h1>
                            <h2><a href="prodInfor?id=${cateProdList.id }">${cateProdList.name }</a></h2>
                        </div>
                        <!--购买等操作-->
                        <div class="c4b5_el">
                        	<div class="c4b5_el_x">
                   ...
                   <%--  </c:if>  --%>          			
                	...
                	<li class="c4_b5_c_box">
                    	...
                    	<div class="c4_b5_c_box_pic">
                        	<div class="c4b5_pic_view">
                            	<a href="prodInfor?id=${prodList.id }"><img src="${prodList.images }"></a>
                            </div>
                        </div>
                        <!--价钱-->
                        <div class="c4_b5_c_box_txt">
                        	<h1>￥ ${prodList.price }</h1>
                            <h2><a href="prodInfor?id=${prodList.id }">${prodList.name }</a></h2>
                        </div>
                        <!--购买等操作-->
                        <div class="c4b5_el">
                        	<div class="c4b5_el_x">
                        ...
                        <c:if test="${sessionScope.user != null}">
                        <ul class="c4b5_option">
                                <li class="shopcar_box"><span class="shopcar01"></span><a href="addCart?id=${prodList.id}&number=1" >加入购物车 </a></li>
                        </ul>
                        </c:if>
                        <c:if test="${sessionScope.user == null}">
                        <ul class="c4b5_option">
