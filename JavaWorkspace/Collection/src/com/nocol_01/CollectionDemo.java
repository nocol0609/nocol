 ...
 * 		boolean removeAll(Collection c):移除一个集合的元素(移除所有)
 * 3:判断功能
 * 		boolean contains(Object o)：判断集合中是否包含指定的元素
 * 		boolean containsAll(Collection c)：判断集合中是否包含指定的集合元素(集合所有的所元素)
...
public class CollectionDemo {
	public static void main(String[] args) {
		...
		Collection c = new ArrayList();  //多态 Collectio(接口)--List(接口)--ArrayList(List接口的实现类)
		...
		// System.out.println("remove:" + c.remove("javaee")); //删除不书友集合内的元素是时返回false
