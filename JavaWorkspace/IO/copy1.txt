 ...
 * 		FileOutputStream(File file)      //将路径封装成File对象
 *		FileOutputStream(String name)
 *
 * 字节输出流操作步骤：FileOutputStream fos = new FileOutputStream("fos.txt");
 * 		A:创建字节输出流对象
 * 		B:写数据
 * 		C:释放资源
 */
public class FileOutputStreamDemo {
	public static void main(String[] args) throws IOException {
		...
		//FileOutputStream fos = new FileOutputStream("fos.txt",true);  //加了true的构造方法可实现追加
		/*
		 * 创建字节输出流对象了做了几件事情：
		 * A:调用系统功能去创建文件
		 * B:创建fos对象
